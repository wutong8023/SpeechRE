...
class SpeechToTextDataset(FairseqDataset):
    ...
    def __init__(
        ...
        self.tokenizer = BartTokenizer.from_pretrained("/data/wangguitao/IWSLT/Data/bartre")
    ...
    def __getitem__(
        ...
        if self.tgt_texts is not None:
            tokenized = self.tokenize_text(self.tgt_texts[index]) + " </s>"
            target = self.tokenizer.convert_tokens_to_ids(tokenized.split(" "))
